...
<?php include_once("header.php")?>
    ...
    <div id="local">
   <div class="caminho">Onde Estou: Trancoso Imóveis &raquo; Painel de Controle &raquo; Clientes
   </div><!--caminho-->
...
$sql_aguardando = 'UPDATE trancoso_imoveis SET imovelStatus = :imovelStatus, imovelConfirma = :imovelConfirma
...
try{
	...
	echo '<div class="ok">Recebemos sua confirmação. assim que validada seu imóvel será anúnciado e poderá ser visto em seus imóveis ativos! por enquanto será visualizado em Aguardando aprovação!</div>';
	  ...
	  echo 'Erro ao atualizar imóvel'.$error_aguardando->getMessage();
       ...
       <?php include_once("sistema/carregando.php");?>
		 ...
		 <h2>Bem vindo ao painel de anúncios da Trancoso Imóveis aqui você pode criar e gerenciar seus anúncios!</h2>
 ...
 $sql_pegaAtivos = 'SELECT * FROM trancoso_imoveis WHERE clienteId = :clienteId 
