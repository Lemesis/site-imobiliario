...
<div id="local">
   <div class="caminho">Onde Estou: Trancoso Imóveis &raquo; Painel de Controle &raquo; Ativos</div><!--caminho-->
...
$sql_termina = 'UPDATE trancoso_imoveis SET imovelTermino = :imovelTermino WHERE imovelId = :imovelId';
