...
<div id="local">
   <div class="caminho">Onde Estou: Trancoso Imóveis &raquo; Painel de Controle</div><!--caminho-->
...
$edit_imoveis = 'UPDATE trancoso_imoveis SET imovelTitulo = :imovelTitulo, imovelNegocio = :imovelNegocio, imovelTipo = :imovelTipo, 
...
<?php
$sql_pegaImagem = 'SELECT * FROM freitas_midias WHERE imovelId = :imovelId';
try{
